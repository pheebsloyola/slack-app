...
function Channel(props){
    const [showHideMember,setShowHideMember] =useState(false);
    ...
    return(
         <div className="direct-message-content">
          ...
          <h1>#{props.channelTitle}</h1>
          <button className="add-members" onClick={handleOpenMemberPage}>+ Add Members</button>
          {showHideMember && <Member channelID={props.channelID} />}
         </div>
